        ...
        {user.role === "retailer" && (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
            ...
            >
              ...
              <p className="text-indigo-300 text-sm mt-1">Overview of your products and models</p>
            </Link>
            <Link
              href="/retailer/products"
              className="bg-gradient-to-br from-blue-600 to-blue-700 text-white rounded-xl p-6 hover:from-blue-700 hover:to-blue-800 transition-all shadow-sm"
            >
              <h3 className="font-semibold text-lg">Manage Products</h3>
              <p className="text-blue-300 text-sm mt-1">Add, edit, and manage your catalog</p>
            </Link>
            <Link
              href="/retailer/models"
              className="bg-gradient-to-br from-emerald-600 to-emerald-700 text-white rounded-xl p-6 hover:from-emerald-700 hover:to-emerald-800 transition-all shadow-sm"
            >
              <h3 className="font-semibold text-lg">Manage Models</h3>
              <p className="text-emerald-300 text-sm mt-1">Upload and manage fashion models</p>
            </Link>
          </div>
        )}
