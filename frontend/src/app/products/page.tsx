          ...
          <form onSubmit={handleSearch} className="mt-6 max-w-xl mx-auto">
            <div className="relative">
              <input
                ...
                className="w-full pl-12 pr-4 py-3 rounded-xl text-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-white/50"
              />
                    ...
                    >
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex items-center justify-between mt-3">
                          <span className="text-lg font-bold text-gray-900">{formattedPrice(product.price)}</span>
